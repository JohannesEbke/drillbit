...
from pyparsing import (
    alphas, alphanums, empty, lineEnd, FollowedBy, Forward, Group,
    OneOrMore, Word, Optional, delimitedList, nums, col, ParseException)
...
INDENT = lineEnd.suppress() + empty + \
    empty.copy().setParseAction(checkSubIndent)
